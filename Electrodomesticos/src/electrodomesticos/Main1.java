...
public class Main1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextArearesultado.append(bombilla.toString());
        Aparato plancha = new Aparato("Plancha", 1200);
        jTextArearesultado.append(plancha.toString());
        Aparato radiador = new Aparato("Radiador", 2000);
        jTextArearesultado.append(radiador.toString());
        jTextArearesultado.append(String.valueOf(Aparato.getConsumoTotal()));
